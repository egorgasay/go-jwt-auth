...
func (_m *Repository) SaveTokenData(ctx context.Context, t models.TokenData) error {
	ret := _m.Called(ctx, t)
...
// Repository_SaveTokenData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveTokenData'
type Repository_SaveTokenData_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - t models.TokenData
func (_e *Repository_Expecter) SaveTokenData(ctx interface{}, t interface{}) *Repository_SaveTokenData_Call {
	return &Repository_SaveTokenData_Call{Call: _e.mock.On("SaveTokenData", ctx, t)}
}

func (_c *Repository_SaveTokenData_Call) Run(run func(ctx context.Context, t models.TokenData)) *Repository_SaveTokenData_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_SaveTokenData_Call) Return(_a0 error) *Repository_SaveTokenData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Repository_SaveTokenData_Call) RunAndReturn(run func(context.Context, models.TokenData) error) *Repository_SaveTokenData_Call {
	_c.Call.Return(run)
	return _c
}
